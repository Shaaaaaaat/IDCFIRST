...
bot.on("callback_query:data", async (ctx) => {
  ...
  // Добавляем обработчик для "Поменять город"
    ...
    await ctx.reply(
      `Пожалуйста, укажите ориентировочную дату тренировки в формате дд.мм (например, 04.12).\nЗа два дня до этой даты я вышлю актуальное расписание для подтверждения или выбора другого дня.`
    );
